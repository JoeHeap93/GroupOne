Feature: Register
  ...
  Scenario: Register with my details
    ...
    And I have entered the name "Alan Baker"
    And I have entered the signup email "hiya123@gmail.com"
    When I click the signup button
    Then I should land on the signup page
    And I have clicked the gender selection
    And I have entered the signup password "secret345"
    ...
    And I have entered the first name "Alan"
    And I have entered the last name "Baker"
    ...
    And I have entered the mobile number "07615432232"
